...
// mustang add it
void VideoReceiveStream2::SendDiffFeedback(int64_t timestamp_ms, int32_t diff_info) {
  rtp_video_stream_receiver_.SendDiffFeedback(diff_info);
}
// mustang end it
...
void VideoReceiveStream2::OnCompleteFrame(std::unique_ptr<EncodedFrame> frame) {
  ...
  SendDiffFeedback(time_now_ms,timing_->diffinfo);
